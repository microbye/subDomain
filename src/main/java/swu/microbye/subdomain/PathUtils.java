...
public class PathUtils {
     ...
     *
     */
    public static boolean allowExtension(String filename,List<String> list){
		boolean flag = false;
    	String postfix = getExtension(filename);
        //if(postfix.isEmpty()){
    	if(postfix == null){
    		return false;
    	}
    ...
    public static void main(String[] args) {
        String fileName = "http://www.swu.edu.cn/xywh/xdjy/xdjy%20(19).pdf";
        System.out.println(PathUtils.trimExtension(fileName));
